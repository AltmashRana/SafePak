...
//        val add: ImageView = view.findViewById(R.id.searchaddfriend_bt)
//
//        init {
...
//                            add.isEnabled = false
//                            add.setImageResource(R.drawable.requestsent_ic)
...
//
//        when(users[position].second) {
//            1 -> {
//                viewHolder.add.isEnabled = false
//                viewHolder.add.setImageResource(R.drawable.requestsent_ic)
//            }
//            2 -> {
//                viewHolder.add.isEnabled = false
...
//
//        viewHolder.dp.startAnimation(animation1)
//        viewHolder.add.startAnimation(animation2)
//    }
